<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bidCreate.aspx.cs" Inherits="manage_bidCreate" %>
                            ...
                            <div class="panel-heading">    
                                    ...
                                    <form id="GmyForm" name="GmyForm" action="" method="post" enctype="multipart/form-data">
                                        <table class="table table-striped table-bordered" id="Table1" border="0">
                                            ...
                                            <tr>
                                                <td width="150" rowspan="2">競標品照片</td>
                                                <td>
		                                    ...
		                                    <tr>
		                                        <td>競標品起始價</td>
		                                        <td colspan="5">
		                                            <input id="StartPrice" type="text" runat="server" /><span class="startMark">*</span>
		                                        </td>
