...
/// <summary>
/// Summary description for DTParameterModel
/// </summary>
public class DTParameterModel
{
    ...
    /// <summary>
    /// Collection of all search condition in the table
    /// </summary>
    public IEnumerable<DTCondition> Condition { get; set; }
}
public sealed class DTCondition
{
