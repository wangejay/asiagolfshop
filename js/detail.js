...
function goCart() {
    ...
    obj.Hand = $("#sHand").val().length == 0 ? 0 : $("#sHand").val();
    obj.Angle = $("#sAngle").val().length == 0 ? 0 : $("#sAngle").val();
    obj.GolfClub = $("#sGolfClub").val().length == 0 ? 0 : $("#sGolfClub").val();
    obj.GolfHand = $("#sGolfHard").val().length == 0 ? 0 : $("#sGolfHard").val();
